...
public class PeopleController : ControllerBase {
    ...
    [HttpPost] public IActionResult Create([FromBody] Person e) {
        var dbPerson = context.PeopleList?.Find(e.Id); 
        if (dbPerson == null) {
    ...
    [HttpPut("{id}")] public IActionResult Update(int? id, [FromBody] Person e) {
        var dbPerson = context.PeopleList!.AsNoTracking().FirstOrDefault(personInDB => personInDB.Id == e.Id);
